      ...
      <div className="flex gap-2">
        {links.map(({ name, href }) => (
          <a
            ...
            className="flex h-10 w-10 items-center justify-center rounded-lg border bg-slate-100 p-2 transition-colors duration-250 ease-in-out-cubic hover:border-slate-400 hover:bg-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:ring-offset-2 focus:ring-offset-slate-50"
          >
            <Icon name={name} />
          </a>
        ))}
